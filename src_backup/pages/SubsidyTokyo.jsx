    ...
    return (
        ...
        >
            ...
            <div className="w-full py-12 md:py-20">
                ...
                <div className="mb-20 max-w-5xl mx-auto px-4 sm:px-6">
                    <h2 className="text-2xl font-black text-[#003366] mb-8 border-l-4 border-blue-600 pl-4">補助金を逃さないための「<span className="mx-1">3</span>つの絶対基準」</h2>
